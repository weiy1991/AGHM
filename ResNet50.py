...
def ResNet50(X_input, classes=1 ,keep_prob=0.8):
    ...
    # add by Wei Yuan
    out = tf.nn.dropout(A_flat, keep_prob = keep_prob) 
    # end by Wei Yuan
    params['flatten'] = A_flat
    A_out, params['out'] = dense(out, classes, name='fc'+str(classes))
...
y = ResNet50(x, 1, keep_prob = keep_prob)
